...
<!-- generated with COPASI 4.24 (Build 197) (http://www.copasi.org) at 2021-07-09 07:15:51 UTC -->
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5013" name="k1" value="5e-09"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5012" name="k1" value="0.0004"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=New Model_1_1,Vector=Compartments[Intracellular]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5011" name="k1" value="0.0058"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=New Model_1_1,Vector=Compartments[Intracellular]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Event_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <TriggerExpression>
          &lt;CN=Root,Model=New Model_1_1,Vector=Compartments[Intracellular],Vector=Metabolites[Energy],Reference=Concentration> lt 48
        </TriggerExpression>
        <DelayExpression>
          0
        </DelayExpression>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Event_3">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model_1_1,Vector=Values[k_aer]" value="5.0000000000000001e-09" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=New Model_1_1,Vector=Values[k_ane]" value="0.00040000000000000002" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=New Model_1_1,Vector=Values[k_usage]" value="0.0057999999999999996" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=New Model_1_1,Vector=Values[energy_thresh]" value="55" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=New Model_1_1,Vector=Reactions[Aerobic]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model_1_1,Vector=Reactions[Aerobic],ParameterGroup=Parameters,Parameter=k1" value="5.0000000000000001e-09" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model_1_1,Vector=Reactions[Anaerobic]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model_1_1,Vector=Reactions[Anaerobic],ParameterGroup=Parameters,Parameter=k1" value="0.00040000000000000002" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model_1_1,Vector=Reactions[Energy_Usage]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model_1_1,Vector=Reactions[Energy_Usage],ParameterGroup=Parameters,Parameter=k1" value="0.0057999999999999996" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
    ...
    <InitialState type="initialState">
      0 6.0221408570000005e+22 0 6.0221408570000005e+22 6.0221408570000005e+22 0 0 6.0221408570000002e+20 1 5.0000000000000001e-09 0.00040000000000000002 0.0057999999999999996 55 
    </InitialState>
  </Model>
  <ListOfTasks>
  ...
  <SBMLReference file="untitled.xml">
    ...
    <SBMLMap SBMLid="Lac_Sec" COPASIkey="Event_3"/>
    ...
    <SBMLMap SBMLid="do_not_move" COPASIkey="Event_1"/>
    ...
    <SBMLMap SBMLid="move" COPASIkey="Event_2"/>
