...
public:
	inline bool passive() { return ((int) custom_data["passive_cell"]) == 1; };
	...
	* Currently, handle only the case of ECM as a density */
	...
	{ return current_value( custom_data["heterotypic_adhesion_min"], custom_data["heterotypic_adhesion_max"], percent ); };
	/** \brief Get the current value of homotypic adhesion strength */
	inline double get_homotypic_strength( double percent )
	{ return current_value( custom_data["homotypic_adhesion_min"], custom_data["homotypic_adhesion_max"], percent ); };

    /** \brief Get the current value of integrin strength */
	inline double get_integrin_strength( double percent )
	{ return current_value( custom_data["ecm_adhesion_min"], custom_data["ecm_adhesion_max"], percent ); };
